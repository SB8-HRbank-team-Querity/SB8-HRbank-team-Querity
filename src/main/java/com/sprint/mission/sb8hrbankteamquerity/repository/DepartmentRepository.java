...
public interface DepartmentRepository extends JpaRepository<Department, Long> {
    ...
    @Query("SELECT d FROM Department d " +
        ...
        ") " +
        "ORDER BY " +
        "    CASE WHEN :sortField = 'name' AND :isAsc = true THEN d.name END ASC, " +
        "    CASE WHEN :sortField = 'name' AND :isAsc = false THEN d.name END DESC, " +
        "    CASE WHEN :sortField = 'establishedDate' AND :isAsc = true THEN d.establishedDate END ASC, " +
        "    CASE WHEN :sortField = 'establishedDate' AND :isAsc = false THEN d.establishedDate END DESC, " +
        "    d.id ASC")
    List<Department> findAllByCursor(
        ...
        @Param("lastDateValue") Instant lastDateValue,
