...
public class EmployeeHistoryServiceImpl implements EmployeeHistoryService {
    ...
    @Override
    public boolean saveEmployeeHistory(EmployeeHistoryDTO employeeHistoryDto) {
        // 필요한 로직이 저장이 됐는지 확인만 있으면 될거 같은데
        EmployeeHistory employeeHistory =
            employeeHistoryRepository.save(employeeHistoryMapper.toEntity(employeeHistoryDto));

        return employeeHistory != null ? true : false;
    }
}
